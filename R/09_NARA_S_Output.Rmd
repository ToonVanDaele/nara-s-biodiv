...
df_redlist <- read.csv(file = "C:/Users/toon_vandaele/toon.vandaele@inbo.be/Project_WET/NARA/NARA_S/DataIN/RL_planten.csv",sep = ";")
...
write.table(df_sums_rl, file = paste0(pathout, "df_sums_rl.csv"), sep = ";", dec = ",")
remove(df_sums_rl)
```
...
write.table(df_sums_rl_auc, file = paste0(pathout, "df_sums_rl_auc.csv"), sep = ";", dec = ",")
```
