...
ggplot(df_probsum, aes(x = X, y = Y, colour = rlw_Current)) +
...
ggplot(df_binsum, aes(x = X, y = Y, colour = rlw_Current)) +
  scale_colour_gradientn(colours = rainbow(3)) +
  geom_point() + coord_fixed()
...
ggplot(df_probsumw, aes(x = X, y = Y, colour = rlw_Current)) +
  scale_colour_gradientn(colours = rainbow(3)) +
  geom_point() + coord_fixed()
...
ggplot(df_binsumw, aes(x = X, y = Y, colour = rlw_Current)) +
  scale_colour_gradientn(colours = rainbow(3)) +
  geom_point() + coord_fixed()
